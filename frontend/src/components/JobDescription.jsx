...
const JobDescription = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        ...
                        <Badge className={'text-[#7209b7] font-bold'} variant="ghost">34LPA</Badge>
                    </div>
                </div>
                <Button
                    disabled={isApplied}
            ...
            <div className='my-4'>
                <h1 className='font-bold my-1'>Role: <span className='pl-4 font-normal text-gray-800'>Frontened</span></h1>
                ...
                <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>12/03/2024</span></h1>
            </div>
        </div>
    )
}
